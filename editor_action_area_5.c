...
void		ft_map_editor_area_action_position_l(t_variable_list *l)
{
...
void		ft_map_editor_area_action_position_size_recall(t_variable_list *l)
{
	int		ts;
	double	p[3];
...
void		ft_map_editor_area_action_position_size_up(t_variable_list *l)
{
	int	ts;
...
void		ft_map_editor_area_action_position_size_down(t_variable_list *l)
{
	int	ts;
...
void		ft_map_editor_area_action_position_size(t_variable_list *l)
{
	if (l->action_select[l->menu_select][++l->action])
	{
		if (l->i.scroll_up)

...
void		ft_map_editor_group_action_position_z(t_variable_list *l)
{
...
void		ft_map_editor_group_action_position_h_up(t_variable_list *l)
{
	double	tmp;
	int		i;
...
void		ft_map_editor_group_action_position_h_down(t_variable_list *l)
{
	double	tmp;
	int		i;
...
void		ft_map_editor_group_action_position_h(t_variable_list *l)
{
	if (l->action_select[l->menu_select][++l->action])
	{
		if (l->i.scroll_up)

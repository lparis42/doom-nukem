...
void		ft_map_editor_group_action_position_v_up(t_variable_list *l)
{
	double	tmp;
	int		i;
...
void		ft_map_editor_group_action_position_vdown(t_variable_list *l)
{
	double	tmp;
	int		i;
...
void		ft_map_editor_group_action_position_v(t_variable_list *l)
{
...
void		ft_map_editor_group_action_position_l_up(t_variable_list *l)
{
	double	tmp;
	int		i;
...
void		ft_map_editor_group_action_position_l_down(t_variable_list *l)
{
	double	tmp;
	int		i;
